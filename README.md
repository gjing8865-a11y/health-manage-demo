...
- [x] Extract STM32 Wi-Fi scan summary messaging and cover it with unit tests.
- [x] Extract STM32 device sync summary formatting and cover it with unit tests.
...
- [x] Extract weather response mapping and invalid-payload guards with tests.
